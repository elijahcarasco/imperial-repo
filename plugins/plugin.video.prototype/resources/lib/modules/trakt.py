...
def getTrakt(url, post=None):
    try:
        ...
        headers = {'Content-Type': 'application/json', 'trakt-api-key': '54878c611fe5fb7503396f40fa1ab10ec7ddd9ddecd80fff5c15e961e4f16c41', 'trakt-api-version': '2'}
        ...
        opost = {'client_id': '54878c611fe5fb7503396f40fa1ab10ec7ddd9ddecd80fff5c15e961e4f16c41', 'client_secret': '90a1840447a1e39d350023263902fe7010338d19789e6260f18df56a8b07a68a', 'redirect_uri': 'urn:ietf:wg:oauth:2.0:oob', 'grant_type': 'refresh_token', 'refresh_token': control.setting('trakt.refresh')}
...
def authTrakt():
    try:
        ...
        result = getTrakt('/oauth/device/code', {'client_id': '54878c611fe5fb7503396f40fa1ab10ec7ddd9ddecd80fff5c15e961e4f16c41'})
        result = json.loads(result)
        ...
        for i in range(0, expires_in):
            try:
                ...
                r = getTrakt('/oauth/device/token', {'client_id': '54878c611fe5fb7503396f40fa1ab10ec7ddd9ddecd80fff5c15e961e4f16c41', 'client_secret': '90a1840447a1e39d350023263902fe7010338d19789e6260f18df56a8b07a68a', 'code': device_code})
                r = json.loads(r)
        ...
        headers = {'Content-Type': 'application/json', 'trakt-api-key': '54878c611fe5fb7503396f40fa1ab10ec7ddd9ddecd80fff5c15e961e4f16c41', 'trakt-api-version': '2', 'Authorization': 'Bearer %s' % token}

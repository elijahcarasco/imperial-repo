    ...
    def episodeDirectoryProgress(self, items):
        ...
        for i in items:
            try:
                ...
                url = 'plugin://script.module.symbiotor?search=episode&title=%s&season=%s&episode=%s' % (systvshowtitle, season, episode)
                sysurl = urllib.quote_plus(url)

                path = 'plugin://script.module.symbiotor?search=episode&title=%s&season=%s&episode=%s' % (systvshowtitle, season, episode)
